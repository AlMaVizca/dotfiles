...
alias build="tmux send-keys -t $YAT_SESSION:$YAT_SESSION 'make build' ENTER"
alias start="tmux send-keys -t $YAT_SESSION:$YAT_SESSION 'make start' ENTER"
alias test="tmux send-keys -t $YAT_SESSION:$YAT_SESSION 'make test' ENTER"
